...
export const categories = [
  {
    ...
    name: "Productos",
    icon: ShoppingBag,
    subcategories: ["Nuevos", "Destacados", "Ofertas", "Lo mas vendido"],
  },
  {
    id: 2,
    name: "Tecnología",
    icon: Smartphone,
    subcategories: ["Computadoras", "Celulares", "Audio", "Accesorios"],
  },
  {
    id: 3,
    name: "Moda",
    icon: Shirt,
    subcategories: ["Hombre", "Mujer", "Ninos", "Calzado"],
  },
  {
    id: 4,
    name: "Supermercado",
    icon: Apple,
    subcategories: ["Lacteos", "Panaderia", "Bebidas", "Snacks"],
  },
  {
    id: 5,
    name: "Ferretería",
    icon: Wrench,
    subcategories: ["Herramientas", "Pinturas", "Electricidad", "Jardin"],
  },
  {
    id: 6,
    name: "Hogar",
    icon: Sofa,
    subcategories: ["Muebles", "Decoracion", "Iluminacion", "Textiles"],
  },
  {
    id: 7,
    name: "Entretenimiento",
    icon: Gamepad2,
    subcategories: ["Consolas", "Videojuegos", "Juguetes", "Streaming"],
  },
  {
    id: 8,
    name: "Educación",
    icon: BookOpen,
    subcategories: ["Cursos", "Papeleria", "Idiomas", "Tecnica"],
  },
  {
    id: 9,
    name: "Deportes",
    icon: Dumbbell,
    subcategories: ["Gym", "Running", "Futbol", "Outdoor"],
  },
  {
    id: 10,
    name: "Salud y Bienestar",
    icon: Heart,
    subcategories: ["Vitaminas", "Cuidado personal", "Fitness", "Nutricion"],
  },
  {
    id: 11,
    name: "Belleza",
    icon: Sparkles,
    subcategories: ["Maquillaje", "Cuidado de piel", "Perfumes", "Cabello"],
  },
  {
    id: 12,
    name: "Automóviles",
    icon: Car,
    subcategories: ["Accesorios", "Mantenimiento", "Audio", "Seguridad"],
  },
  {
    id: 13,
    name: "Mascotas",
    icon: PawPrint,
    subcategories: ["Perros", "Gatos", "Higiene", "Juguetes"],
  },
  {
    id: 14,
    name: "Libros",
    icon: Book,
    subcategories: ["Ficcion", "No ficcion", "Infantil", "Negocios"],
  },
  {
    id: 15,
    name: "Música",
    icon: Music,
    subcategories: ["Instrumentos", "Accesorios", "Vinilos", "Estudio"],
  },
  {
    id: 16,
    name: "Viajes",
    icon: Plane,
    subcategories: ["Vuelos", "Hoteles", "Seguros", "Equipaje"],
  },
  {
    id: 17,
    name: "Jardín",
    icon: Leaf,
    subcategories: ["Plantas", "Herramientas", "Riego", "Decoracion"],
  },
  {
    id: 18,
    name: "Accesorios",
    icon: Headphones,
    subcategories: ["Tecnologia", "Moda", "Viaje", "Hogar"],
  },
  {
    id: 19,
    name: "Utilidades",
    icon: Zap,
    subcategories: ["Hogar", "Oficina", "Escolar", "Organizacion"],
  },
];
  ...
  3: [
      ...
      variants: [
        {
          ...
          price: 650,
          stock: 7,
          attributes: { color: "Negro", size: "30" },
        },
        {
          id: 8,
          name: "Negro - Talla 32",
          price: 650,
          stock: 10,
          attributes: { color: "Negro", size: "32" },
        },
        {
          id: 9,
          name: "Gris - Talla 30",
    ...
    },
    {
      ...
      variants: [
        ...
        {
          id: 13,
          name: "Azul Marino - Talla M",
          price: 2800,
          stock: 8,
          attributes: { color: "Azul Marino", size: "M" },
        },
        {
          id: 14,
          ...
          price: 2800,
          stock: 3,
          attributes: { color: "Azul Marino", size: "L" },
        },
      ],
    },
    {
      ...
      variants: [
        {
          id: 15,
          name: "Blanco - Talla 40",
          price: 1500,
          stock: 12,
          attributes: { color: "Blanco", size: "40" },
        },
        {
          id: 16,
          ...
          price: 1500,
          stock: 15,
          attributes: { color: "Blanco", size: "42" },
        },
        {
          id: 17,
          name: "Negro - Talla 40",
          price: 1500,
          stock: 10,
          attributes: { color: "Negro", size: "40" },
        },
        {
          id: 18,
          name: "Negro - Talla 42",
          price: 1500,
          stock: 8,
          attributes: { color: "Negro", size: "42" },
        },
      ],
    },
    {
